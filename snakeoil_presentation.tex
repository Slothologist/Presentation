...
\begin{document}
	...
	\begin{frame}{F-Verteilung}
		...
		\end{center}
		\pause
		\textbf{allgemeine Mathematiker:} \emph{$F$ ist der Quotient zweier Chi-Quadrat-Verteilter Zufallsvariablen normiert um ihre Freiheitsgrade.} \\ \vspace{1ex}
		\pause
		\textbf{Statistiker:} \emph{$F$ ist ein Maß für}
	\end{frame}
	...
	\begin{frame}{semidisordinale Interaktion}
		%Frage ans Publikum: Wenn sich bei ordinaler I die Linien nie kreuzen, bei disordinaler I aber immer, was könnte dann die semidis I sein? 
		\begin{itemize}
	...
	\begin{frame}{semidisordinale Interaktion - Interpretation}
		\begin{itemize}
			\item Interpretation nur für den ordinalen Faktor sinnvoll
	...
	\section{Anwendungsvorraussetzungen der Varianzanalyse}
