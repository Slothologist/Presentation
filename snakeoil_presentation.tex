	...
	Interaktion findet immer zwischen (mindestens) zwei unterschiedlichen UV statt
		...
		\note{
			...
			\begin{itemize}
				...
				\item semidisordinale Interaktion
			\end{itemize}
			\textbf{Ich habe zwei (leicht unterschiedliche) Definitionen für die einzelnen Arten gefunden. Gehe nacheinander durch. Bei Fragen gerne melden, evtl verschiebe ich die dann aber auf später}
		}
	\end{frame}
	...
	\begin{frame}{Nullinteraktion}
		...
		\note{
			\begin{itemize}
				...
				\item Auswirkungen einer UV sind auf allen Stufen der anderen UV gleich
				\item UVs wirken unabhängig voneinander auf die AV
				\item Die Kenntnis der Wirkung beider UVs reicht aus, um den Mittelwert jeder Zelle voraussagen zu können \textbf{Zellen sind dabei ``Untergruppen''}
				\item im Liniendiagramm: parallel
			\end{itemize}
			}
	\end{frame}
