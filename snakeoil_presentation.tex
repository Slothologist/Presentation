...
\begin{document}
	...
	Interaktion findet immer zwischen (mindestens) zwei unterschiedlichen UV statt
		...
		\note{
			...
			die gucken wir uns im folgenden genauer an
		}
	\end{frame}
	...
	\begin{frame}{Nullinteraktion - Diagramm}
		...
		\end{itemize}
		Bild mit vertauschten Achsen an die Tafel malen
		 }
	\end{frame}
	...
	\begin{frame}{ordinale Interaktion}
		\begin{itemize}
			...
			\item Linien zeigen in dieselbe Richtung
		\end{itemize}
	...
	\begin{frame}{ordinale Interaktion - Interpretation}
		\begin{itemize}
			\item Interpretation sinnvoll und eindeutig \note{1. wir sehen, dass die UV sich zwar beeinflussen und gegenseitig verstärken, können aber trotzdem Aussagen über das Verhalten machen\\ }
